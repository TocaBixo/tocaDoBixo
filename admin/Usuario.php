...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.1/jquery.min.js"></script>   
    ...
    if (confirm("Tem certeza que deseja excluir este usuário?") === true) {
        x = "Certo então";
        var codi;
            codi = document.getElementById('hidden').value;
        location.href="excluir.php?codigo="+codi;
...
$tipoDoUsuario = $usuarios['TIPO_USUARIO'];
    ...
    echo '<td> <a id="link2" href=../frmAtualizar.php?codigo='.$usuarios['COD_LOGIN'].'> Atualizar </a> </td>';
    echo '<div id="confirmar"> <td> <a id="link2" onclick="confirma()"> Excluir </a> </td> </div>';
...
echo '<input type="hidden " id="hidden" value=" '.$usuarios['COD_LOGIN'];' ">  ';
